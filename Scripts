-- ty soujahub for the nice free loader
...
local Config = {
    ...
    -- Sound Effects (IDs have been replaced with verified, working assets)
    Sounds = {
        Open = "rbxassetid/913363037",      -- UI Open Sound
        Update = "rbxassetid/6823769213",     -- UI Click
        Success = "rbxassetid/10895847421",   -- Success Chime
        Failure = "rbxassetid/142642633",     -- Error Sound
        TipPing = "rbxassetid/5151558373"      -- Notification Ping
    },
...
screenGui.Name = "SeraphisHubLoader"
...
-- A function to display a fatal error on the UI and halt execution
...
task.spawn(function()
    ...
    if success then
        ...
        -- Perfectly chain the outro to the flash animation's completion.
        ...
        warn("[SeraphisHub] Critical Error: The main script failed to load.", result)
    end
end)
